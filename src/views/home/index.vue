	...
	<div class="home">
							...
							<el-row>
								...
								<el-col :span="24">
									<el-col :xs="12" :sm="12" :md="8" class="right-l-v">
										...
										<div class="right-value">蔚蓝出行</div>
									</el-col>
			...
			<el-col :md="24" :lg="8" :xl="8" class="mb15">
				<el-card shadow="hover">
					<div slot="header">
						...
						<el-button class="home-card-more" type="text" @click="onOpenMore">{{ $t('message.card.title3') }}</el-button>
					</div>
					<div class="info">
		...
		<el-card shadow="hover">
			<div slot="header">
				...
				<el-button class="home-card-more" type="text" @click="onOpenMore">{{ $t('message.card.title5') }}</el-button>
			</div>
...
export default {
	...
	methods: {
		...
		// 跳转
		onOpenMore() {
			window.open('https://www.weilango.com/');
		},
	},
	watch: {
		// 监听 vuex 数据变化
